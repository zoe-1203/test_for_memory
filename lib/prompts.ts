...
因为用户是在${timeInfo}的时候，抽2026年的牌，所以如果月份到了下半年，用户的感情状态你需要结合牌来看是否会发生变化。比如下半年不可能还是在暧昧中了。
` : '';
...
- 比如"你抽牌时的感情状态是暧昧中，但结合牌意，到了 ${monthNumber}月，你们的关系可能出现一些变化。"，或者“如果到时候已经在一起/还在暧昧中...”
...
${singleStatusChangeNote}${ambiguousStatusChangeNote}- 身份类型：${careerDisplay}
${singleGuidance}${ambiguousGuidance}
## 现在的时间是：
${timeInfo || '（未提供）'}
